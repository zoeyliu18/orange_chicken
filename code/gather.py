		...
		####################### Morfessor ######################
			...
			for n in range(1, 51):
				...
				for choice in choices:
					with io.open(args.input + d + '/' + r + '/morfessor/' + lang + '_test_eval_morf_' + str(n) + choice, encoding = 'utf-8') as f:
						...
						full_data.append([lang, 'Morfessor', 'Accuracy', str(n) + choice, scores[0], d, r])
						full_data.append([lang, 'Morfessor', 'Precision', str(n) + choice, scores[1], d, r])
						full_data.append([lang, 'Morfessor', 'Recall', str(n) + choice, scores[2], d, r])
						full_data.append([lang, 'Morfessor', 'F1', str(n) + choice, scores[3], d, r])
						full_data.append([lang, 'Morfessor', 'Avg. Distance', str(n) + choice, 1 - scores[4], d, r])
				...
				data.append([lang, 'Morfessor', 'Accuracy', n, statistics.mean(accuracy), d, r])
				data.append([lang, 'Morfessor', 'Precision', n, statistics.mean(precision), d, r])
				data.append([lang, 'Morfessor', 'Recall', n, statistics.mean(recall), d, r])
				data.append([lang, 'Morfessor', 'F1', n, statistics.mean(F1), d, r])
				data.append([lang, 'Morfessor', 'Avg. Distance', n, 1 - statistics.mean(dist), d, r])
		...
		####################### Seq2Seq ######################
			...
			for n in range(1, 51):
				...
				for choice in choices:
					...
					with io.open(args.input + d + '/' + r + '/seq2seq/' + lang + '_test_eval_' + str(n) + choice, encoding = 'utf-8') as f:
						scores = []
						for line in f:
							toks = line.strip().split(': ')
							scores.append(float(toks[-1]))
						...
						full_data.append([lang, 'Seq2seq', 'Accuracy', str(n) + choice, scores[0], d, r])
						full_data.append([lang, 'Seq2seq', 'Precision', str(n) + choice, scores[1], d, r])
						full_data.append([lang, 'Seq2seq', 'Recall', str(n) + choice, scores[2], d, r])
						full_data.append([lang, 'Seq2seq', 'F1', str(n) + choice, scores[3], d, r])
						full_data.append([lang, 'Seq2seq', 'Avg. Distance', str(n) + choice, 1 - scores[4], d, r])
				...
				data.append([lang, 'Seq2seq', 'Accuracy', n, statistics.mean(accuracy), d, r])
				data.append([lang, 'Seq2seq', 'Precision', n, statistics.mean(precision), d, r])
				data.append([lang, 'Seq2seq', 'Recall', n, statistics.mean(recall), d, r])
				data.append([lang, 'Seq2seq', 'F1', n, statistics.mean(F1), d, r])
				data.append([lang, 'Seq2seq', 'Avg. Distance', n, 1 - statistics.mean(dist), d, r])
